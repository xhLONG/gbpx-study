...
if (window.location.host == 'wcs1.shawcoder.xyz' & window.location.pathname == '/gdcecw/play_pc/playmp4_pc.html') {
  window.onload = function () {
    console.log('开始自动播放视频', new Date().toLocaleString())
    let is_muted = false;
    const k = 30;
    let j = 0;
    while (!is_muted && j < k) {
...
function do_study(selector) {
  ...
  div.innerHTML = '<iframe id="auto_gbpx" name="auto_gbpx" src="'+course_url+'" height = "300" width = "400" frameborder="0" scrolling="auto"></iframe>';
